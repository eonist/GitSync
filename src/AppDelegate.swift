...
class AppDelegate: NSObject, NSApplicationDelegate{
    ...
    func applicationDidFinishLaunching(aNotification: NSNotification) {
        ...
        win = CustomWin(300,300)//TranslucencyWin()//TranslucentWin()//StashWin(300,300)//CustomWin(300,300)//Win()//Win()//TranslucentWin()//CustomWin(300,200)//Win()//CustomWin()/*Init the window*///Win()//TranslucentWin()
