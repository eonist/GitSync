...
class WinView:FlippedView{
    ...
    func testSkin(){
        ...
        */
        ...
        let css:String = "Element{fill:purple;fill-alpha:0.5;line:linear-gradient(bottom,green,orange);line-thickness:10px;corner-radius:10px;}"//"Blob{fill:green;fill-alpha:1.0;corner-radius:10px;}"//
