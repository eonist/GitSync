...
class WinView:FlippedView{
    ...
    */
    ...
    func testTextButton(){
        ...
        let textCSS:String = "Text{font:Lucida Grande;selectable:false;size:22px;color:blue;align:center;backgroundColor:orange;background:false;}Text:down{color:red;}"//
        css += textCSS
