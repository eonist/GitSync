...
class WinView:FlippedView{
    ...
    func testTextButton(){
        ...
        css += "Text{font:Lucida Grande;selectable:false;size:12px;color:gray;align:center;backgroundColor:orange;background:false;}Text:down{color:black;margin-top:10px}"//
        StyleManager.addStyle(css)
    ...
    func testSkin(){
        ...
        */
        ...
        let css = "Element{fill:red;margin-top:20px;}"//linear-gradient(top,blue,red)
        let styleCollection:IStyleCollection = CSSParser.styleCollection(css)
        StyleManager.addStyle(styleCollection.styles)
