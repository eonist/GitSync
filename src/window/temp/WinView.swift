...
class WinView:FlippedView{
    ...
    */
    ...
    func gradientTest(){
        ...
        let css:String = "Element{fill:linear-gradient(top,gray,white);line:gray;line-alpha:0.6;line-thickness:1px;corner-radius:4px;line-offset-type:center;}"//"Blob{fill:green;fill-alpha:1.0;corner-radius:10px;}"//
