...
class WinView2:FlippedView{
    ...
    */
    ...
    func radialGradientTest(){
        ...
        let gradient = Gradient([NSColor.blueColor().CGColor,NSColor.redColor().CGColor],[],GradientType.Radial,1.5707963267949,CGPoint(0,0),CGPoint(0,1),CGSize(1,1),CGSize(0,0))
