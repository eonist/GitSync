...
class WinView2:FlippedView{
    ...
    */
    ...
    func radialGradientTest2(){
        ...
        let gradient = RadialGradient([NSColor.blackColor().CGColor,NSColor.whiteColor().CGColor],[],π/2,CGPoint(0.0,1)/*startP*/,CGPoint(0.5,0.5)/*y-focalRatio*/,CGSize(1,1)/*start-scale*/,CGSize(0,0)/*endScale*/)
        let fill:GradientFillStyle = GradientFillStyle(gradient);
        /*Rect*/
