...
class TopBar:Element{
    ...
    override func resolveSkin() {
        ...
        StyleManager.addStyle("TopBar TextButton#back{width:50px;float:left;clear:none;}")
        backButton = addSubView(TextButton("Back",32,24,self,"back"))
        
        StyleManager.addStyle("TopBar TextButton#add{width:50px;float:right;clear:none;}")
