class RepoUtils{//Utility methods for parsing the repository.xml file
	...
	func compileRepoList(filePath:String)->[Dictionary<String,String>]{
		let xml:Dictionary<String,Any> = XMLParser.data(filePath)
                //
		let children:[Dictionary<String,String>] = ((((xml["."] as! Dictionary<String,Any>)["repositories"] as! [Dictionary<String,Any>])[0] as! [Dictionary<String,Any>])["."] as! Dictionary<String,Any>)["repository"] as! Dictionary<String,String>
