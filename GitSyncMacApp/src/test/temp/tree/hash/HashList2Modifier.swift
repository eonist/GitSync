...
class HashList2Modifier {
     ...
     */
    static func addDescendants(_ list:inout [[Int]],_ idx2d:Int,_ tree:Tree) -> Int{
        let idx3d:[Int] = list[idx2d]
     ...
     */
    static func removeDescendants(_ list:inout [[Int]],_ idx2d:Int, _ tree:Tree) -> Int{
