...
extension SlidableScrollable3 {
    ...
    func onScrollWheelChange(_ event:NSEvent) {
        ...
        let horProg:CGFloat = SliderListUtils.progress(event.delta[.hor], 5/*interval(.hor)*/, slider(.hor).progress)//TODO: ⚠️️ merge these 2 lines into one and make a method in SliderListUtils that returns point
