...
class AppDelegate:NSObject, NSApplicationDelegate {
    ...
    func targetAnimationTest(){
        ...
        let animator:Spring = Spring<CGPoint>(progress,(CGPoint(0.02,0.02),CGPoint(0.90,0.90)), (CGPoint(0,0),CGPoint(0,0),CGPoint(0,0)), Spring.pointStopAssert)/*setup Mover animator*/
