...
class Unfoldables {
     ...
     */
    static let arr:[UnFoldable.Type] = [Text.self,TextInput.self,RadioButton.self,CheckBoxButton.self,TextButton.self,Text.self,FilePicker.self,Container.self,Section.self]
    /**
