...
class MenuView:Element{
    ...
    lazy var buttonSection:Section = {return self.addSubView(Section(200,MenuView.h,self,"buttonSection"))/*The nav bar*/}()
    ...
    func createButtons(){
        ...
        MenuView.buttonTitles.forEach { buttonTitle in
