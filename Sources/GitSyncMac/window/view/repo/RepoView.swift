...
class RepoView:Element {
    ...
    lazy var treeList:TreeList3 = {return  self.addSubView(TreeList3(self.getWidth(), self.getHeight(), CGSize(24,24), RepoView.treeDP, self))}()//if(RepoView.selectedListItemIndex.count > 0){TreeListModifier.selectAt(treeList!, RepoView.selectedListItemIndex)}
