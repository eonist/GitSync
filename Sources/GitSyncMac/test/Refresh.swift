...
class RefreshUtils{
    ...
    private static func commitCount(_ dp:CommitDP,_ repo:RepoItem)->Int{
        ...
        let totCommitCount:Int = GitUtils.commitCount(repo.localPath).int - 1//👈Git call/*Get the total commitCount of this repo*/
...
private class Utils{
     ...
     */
    static func commitItems(_ localPath:String,_ limit:Int, _ onComplete:)->[String]{
